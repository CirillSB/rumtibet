...
/***/ "./js/custom-appearance-select-fields/customAppearanceSelectFields.js":
/*!****************************************************************************!*\
  !*** ./js/custom-appearance-select-fields/customAppearanceSelectFields.js ***!
  \****************************************************************************/
/*! exports provided: setCustomAppearanceSelectFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setCustomAppearanceSelectFields", function() { return setCustomAppearanceSelectFields; });
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables */ "./js/custom-appearance-select-fields/variables.js");

var setCustomAppearanceSelectFields = function setCustomAppearanceSelectFields() {
  var canvas = document.querySelector('body');
  var shellContents = document.querySelectorAll('[data-shell-contents]');
  shellContents.forEach(function (e) {
    var shellField;
    e.style.opacity = 0;
  ...
  var creatPlaceholders = function creatPlaceholders() {
    ...
    var originalProperties = shellContents[0];
    var shellField = document.querySelectorAll('.shell-field');
    var placeholder;
    for (var i = 0; i < shellField.length; i++) {
      var placeholderText = void 0;
      placeholder = document.createElement('div');
      placeholder.classList.add('placeholder');
      var placeholderStyles = window.getComputedStyle(originalProperties);
      ...
      switch (shellContents[i]) {
        case location:
          placeholderText = _variables__WEBPACK_IMPORTED_MODULE_0__["PLACEHOLDER_LOCATION"];
          break;
        case date:
          placeholderText = _variables__WEBPACK_IMPORTED_MODULE_0__["PLACEHOLDER_DATE"];
          break;
        case participants:
          placeholderText = _variables__WEBPACK_IMPORTED_MODULE_0__["PLACEHOLDER_PARTICIPANTS"];
          break;
      }
...
/***/ "./js/custom-appearance-select-fields/variables.js":
/*!*********************************************************!*\
  !*** ./js/custom-appearance-select-fields/variables.js ***!
  \*********************************************************/
...
/* harmony import */ var _custom_appearance_select_fields_customAppearanceSelectFields__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./custom-appearance-select-fields/customAppearanceSelectFields */ "./js/custom-appearance-select-fields/customAppearanceSelectFields.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    // initPlaceholders();
    // initFormFields();
    Object(_custom_appearance_select_fields_customAppearanceSelectFields__WEBPACK_IMPORTED_MODULE_5__["setCustomAppearanceSelectFields"])();
  });
});
