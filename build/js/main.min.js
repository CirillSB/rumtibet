...
/* harmony import */ var _modules_init_menu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-menu.js */ "./js/modules/init-menu.js");
/* harmony import */ var _utils_test_webp_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/test-webp.js */ "./js/utils/test-webp.js");
/* harmony import */ var _native_options_markup_init_form_fields__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./native-options-markup/init-form-fields */ "./js/native-options-markup/init-form-fields.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_test_webp_js__WEBPACK_IMPORTED_MODULE_4__["testWebP"])();
  // Modules
  // ---------------------------------
  Object(_modules_init_menu_js__WEBPACK_IMPORTED_MODULE_3__["initMenu"])();
  ...
  window.addEventListener('load', function () {
    ...
    // getCustomSelect();
    // initPlaceholders();
    Object(_native_options_markup_init_form_fields__WEBPACK_IMPORTED_MODULE_5__["initFormFields"])();
  });
});
...
var initMenu = function initMenu() {
  var BURGER_ADDRESS = 'img/sprite.svg#burger';
  var CLOSE_ADDRESS = 'img/sprite.svg#icon-close';
  ...
  var changeImageButton = function changeImageButton() {
...
/***/ "./js/native-options-markup/custom-appearance-fields.js":
/*!**************************************************************!*\
  !*** ./js/native-options-markup/custom-appearance-fields.js ***!
  \**************************************************************/
/*! exports provided: creatCustomAppearanceFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "creatCustomAppearanceFields", function() { return creatCustomAppearanceFields; });
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables */ "./js/native-options-markup/variables.js");

var creatCustomAppearanceFields = function creatCustomAppearanceFields() {
  var customFields = document.querySelectorAll('[data-custom-fields]');
  var customIcon;
  ...
  var svgSize = {
    width: "width: '".concat(_variables__WEBPACK_IMPORTED_MODULE_0__["width"], "'"),
    height: _variables__WEBPACK_IMPORTED_MODULE_0__["height"]
  };
  var iconAddress = '../img/sprite.svg';
  var svgIcons = {
    arrowDown: 'arrow-down',
    star: 'star'
  };
  var useAddress = 'xlink:href=' + "\"".concat(iconAddress, "#").concat(svgIcons.arrowDown, "\"");
  var template = document.querySelector('#custom-icon');
  var customIconImage = template.content.cloneNode(true);
  var svg = customIconImage.querySelector('svg');
  var use = customIconImage.querySelector('use');
...
/***/ "./js/native-options-markup/init-form-fields.js":
/*!******************************************************!*\
  !*** ./js/native-options-markup/init-form-fields.js ***!
  \******************************************************/
/*! exports provided: initFormFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFormFields", function() { return initFormFields; });
/* harmony import */ var _variables_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./variables.js */ "./js/native-options-markup/variables.js");
/* harmony import */ var _custom_appearance_fields__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./custom-appearance-fields */ "./js/native-options-markup/custom-appearance-fields.js");


var initFormFields = function initFormFields() {
  var canvas = document.querySelector('body');
  var usedElements = document.querySelectorAll('[data-placeholder]');
  var formFields = document.querySelectorAll('[data-form-field]');
  var location = document.querySelector('#location-select');
  var date = document.querySelector('#date-input');
  var participants = document.querySelector('#participants-select');
  var usedElementStyles = window.getComputedStyle(formFields[0]);
  var placeholder;
  var creatPlaceholders = function creatPlaceholders() {
    for (var i = 0; i < formFields.length; i++) {
      ...
      switch (formFields[i]) {
        case location:
          placeholderText = _variables_js__WEBPACK_IMPORTED_MODULE_0__["PLACEHOLDER_LOCATION"];
          break;
        case date:
          placeholderText = _variables_js__WEBPACK_IMPORTED_MODULE_0__["PLACEHOLDER_DATE"];
          break;
        case participants:
          placeholderText = _variables_js__WEBPACK_IMPORTED_MODULE_0__["PLACEHOLDER_PARTICIPANTS"];
          break;
      }
  ...
  Object(_custom_appearance_fields__WEBPACK_IMPORTED_MODULE_1__["creatCustomAppearanceFields"])();
  console.log('obj');
};

/***/ }),

/***/ "./js/native-options-markup/variables.js":
/*!***********************************************!*\
  !*** ./js/native-options-markup/variables.js ***!
  \***********************************************/
/*! exports provided: PLACEHOLDER_LOCATION, PLACEHOLDER_DATE, PLACEHOLDER_PARTICIPANTS, width, height */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PLACEHOLDER_LOCATION", function() { return PLACEHOLDER_LOCATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PLACEHOLDER_DATE", function() { return PLACEHOLDER_DATE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PLACEHOLDER_PARTICIPANTS", function() { return PLACEHOLDER_PARTICIPANTS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "width", function() { return width; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "height", function() { return height; });
var PLACEHOLDER_LOCATION = 'Локация для тура';
var PLACEHOLDER_DATE = 'Дата похода';
var PLACEHOLDER_PARTICIPANTS = 'Участники';
var width = 15;
var height = 15;
